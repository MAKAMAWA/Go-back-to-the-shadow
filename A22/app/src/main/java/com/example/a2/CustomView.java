...
public class CustomView extends View {
    ...
    protected void onDraw(Canvas canvas){
        ...
        canvas.drawText("20", 90, 380, blackPaint);
        canvas.drawText("15", 90, 580, blackPaint);
        canvas.drawText("10", 90, 780, blackPaint);
        canvas.drawText("05", 90, 980, blackPaint);
        ...
        for (int i = 0;i < l.size(); i++){
            ...
            float cy = (1150-(200/5)*l.get(i));

            canvas.drawCircle(cx,cy,30,p);

            if(i>0){
                float ox = ((viewWidth/8)*(i-1))+150;
                float oy = (1150-(200/5)*l.get(i-1));
        ...
        for (int i = 0;i < l1.size(); i++){
            ...
            float cx = ((viewWidth/8)*i)+150;
            float cy = (1150-(200/5)*l1.get(i));

            canvas.drawCircle(cx,cy,30,p1);

            if(i>0){
                float ox = ((viewWidth/8)*(i-1))+150;
                float oy = (1150-(200/5)*l1.get(i-1));
        ...
        for (int i = 0;i < l2.size(); i++){
            ...
            float cx = ((viewWidth/8)*i)+150;
            float cy = (1150-(200/5)*l2.get(i));

            canvas.drawCircle(cx,cy,30,p2);

            if(i>0){
                float ox = ((viewWidth/8)*(i-1))+150;
                float oy = (1150-(200/5)*l2.get(i-1));
